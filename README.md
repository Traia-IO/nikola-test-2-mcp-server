...
- **Nikola Test 2 Website**: [https://petstore.swagger.io/](https://petstore.swagger.io/)
- **API Documentation**: []()
...
1. Clone this repository:
   ```bash
   git clone https://github.com/Traia-IO/nikola-test-2-mcp-server.git
   cd nikola-test-2-mcp-server
   ```
...
1. Create API client functions for Nikola Test 2 endpoints
